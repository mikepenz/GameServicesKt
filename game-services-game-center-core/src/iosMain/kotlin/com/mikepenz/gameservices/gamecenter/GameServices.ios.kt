...
public class GameCenterBackend public constructor(
    @property:InternalGameServicesApi public val presentingViewController: () -> UIViewController,
) : GameServices by createIosGameServices(presentingViewController)

private fun createIosGameServices(presentingViewController: () -> UIViewController): GameServices =
    IosGameServices(
